...
exports.run = function(i18n_path, options) {
	var languages = i18n.getLanguages(i18n_path),
		strings_found = [],
		strings_missing = [],
	...
	_.each(languages, function(language) {
		paths_language[language] = path.join(i18n_path, language, 'strings.xml');
		strings_language_found[language] = strings.read(paths_language[language]);
